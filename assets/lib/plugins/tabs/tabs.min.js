+ function ($) {
    ...
    Tabs.prototype.open = function (options) {
        ...
        //生成Tab头
        var $element = $('<a id="{id}-tab" data-href="#{id}" title="{title}"  role="tab" data-toggle="tabs"><i class="fa fa-refresh" data-tabs="refresh"></i> {title} <i class="fa fa-times" data-tabs="close"></i></a>'
